...
var PICTURE_SIZE = 1000000;
var PROMOTIONAL_MATERIAL_SIZE = 10000;
var JOB_OFFER_SIZE = 10000;
var LOGO_SIZE = 10000;
...
function getStorage(fileLocation) {
  var storage = multer.diskStorage({
    destination: function (req, file, cb) {
      cb(null, path.resolve(__dirname + fileLocation));
    },
...
exports.pictureUpload = function(){
  console.log('got to upload module.');
  var storage = getStorage(PICTURE_LOCATION);
  console.log('storage function worked!!');

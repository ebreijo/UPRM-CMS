...
var PROMOTIONAL_MATERIAL_SIZE = 5000000;
var JOB_OFFER_SIZE = 5000000;
var LOGO_SIZE = 2000000; // 2MB
var PUBLIC_DOCUMENT_SIZE = 5000000;
...
var PUBLIC_DOCUMENT_LOCATION = HOME_LOCATION + 'publicDocuments/';

var PICTURE_ID = 'image';
var PROMOTIONAL_MATERIAL_ID = 'image';
var JOB_OFFER_ID = 'image';
var LOGO_ID = 'image';
var PUBLIC_DOCUMENT_ID = 'image';
 ...
 * Get the Multer upload function for a Logo.
 */
exports.publicDocumentUpload = function(){
  var storage = getStorage(PUBLIC_DOCUMENT_LOCATION);
  var upload = getUpload(storage, PUBLIC_DOCUMENT_SIZE, PUBLIC_DOCUMENT_ID);
  return upload;
};

...
exports.logoCleanup = function(req, res) {

  var logoPath = __dirname + '/../../app/' + req.body.logoPath;
  ...
  fs.exists(logoPath, function(exists) {
    if (exists) {
      fs.unlink(logoPath, function (err) {
        ...
        console.log('File ' + req.body.logoPath + ' deleted successfully!');
      });
    } else {
      console.log('No file exists in ' + req.body.logoPath);
    }

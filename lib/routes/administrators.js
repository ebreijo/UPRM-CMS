...
var authenticateStudenrOrAdmin = require('../middleware').authStudentOrAdmin;
...
module.exports = function(router) {
  ...
  router.get('/api/admins/jobFairDates', authenticateStudenrOrAdmin, admins.getJobFairDates);

...
module.exports = function(router) {
  ...
  router.delete('/api/aboutUs/requirements/:requirementId', aboutUs.deleteRequirement);
  ...
  router.delete('/api/aboutUs/companyServices/:companyServiceId', aboutUs.deleteCompanyService);
  ...
  router.delete('/api/aboutUs/policies/:policyId', aboutUs.deletePolicy);
  ...
  router.delete('/api/aboutUs/ourStaff/:ourStaffId', aboutUs.deleteStaff);
  ...
  router.delete('/api/aboutUs/studentServices/:studentServiceId', aboutUs.deleteStudentService);
};

...
module.exports = function(router) {
  ...
  router.get('/api/students/companies/:studCompanyId/promotionalMaterials', students.getActiveCompanyPromotionalMaterials);
  // Get PromID Parameter.
  router.param('studPromotionalId', students.getPromId);
  // Get Promotional Material given Promotional ID
  router.get('/api/students/companies/:studCompanyId/promotionalMaterials/:studPromotionalId', students.getCompanyPromotionalMaterial);

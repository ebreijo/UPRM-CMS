...
exports.sendOnCampusServiceEmail = function(body) {
  ...
  var htmlBody = '<h3>New On-Campus Service</h3>' +
    '<ul>' +
      ...
      '<li><strong>Other Event Description:&nbsp;</strong>' + body.otherEventDescription + '</li>' +
  ...
  var textBody = 'New On-Campus Service \n' +
    ...
    '\t Other Event Description: ' + body.otherEventDescription + '\n' +
    '\t Date: ' + body.date + '\n' +
    '\t Hour: ' + body.hour + '\n' +
...
exports.sendAdminAccessEmail = function(req) {
  ...
  var fullUrl = req.protocol + '://' + req.get('host') + '/adminRegistration';

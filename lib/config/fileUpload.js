...
var PICTURE_SIZE = 1000;
var PROMOTIONAL_MATERIAL_SIZE = 1000;
var JOB_OFFER_SIZE = 1000;
var LOGO_SIZE = 1000;

// Example of Location that works:
// '/../../app/media/landingPagePictures/'

var HOME_LOCATION = '/../../app/media/';
var PICTURE_LOCATION = HOME_LOCATION + 'landingPagePictures/';
var PROMOTIONAL_MATERIAL_LOCATION = HOME_LOCATION + 'promotionalMaterialPDFs/';
var JOB_OFFER_LOCATION = HOME_LOCATION + 'jobOffersPDFs/';
...
function getUpload(storage, fileSize, fileType) {
  var upload = multer({
    storage: storage,
    limits: {
      fileSize: fileSize,
...
exports.pictureUpload = function(){
  ...
  return getUpload(storage, PICTURE_SIZE, PICTURE_ID);
};
...
exports.jobOfferUpload = function(){
  ...
  return getUpload(storage, JOB_OFFER_SIZE, JOB_OFFER_ID);
};
...
exports.promotionalMaterialUpload = function(){
  ...
  return getUpload(storage, PROMOTIONAL_MATERIAL_SIZE, PROMOTIONAL_MATERIAL_ID);
};
...
exports.logoUpload = function(){
  ...
  return getUpload(storage, LOGO_SIZE, LOGO_ID);
};
